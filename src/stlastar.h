...
public: // data
	...
	class Node
	{
		public:
			...
			float g; // getCost of this node + its predecessors
			float h; // heuristic estimate of distance to goal
			float f; // sum of cumulative getCost of predecessors and self and heuristic
...
public:
	...
	virtual float GoalDistanceEstimate( T &nodeGoal ) = 0; // Heuristic function which computes the estimated getCost to the goal node
	...
	virtual float GetCost( T &successor ) = 0; // Computes the getCost of travelling from this node to the successor node
